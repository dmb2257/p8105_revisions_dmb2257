...
A tidy dataset was created by merging the zori and zipcode data sets by zip code. The dataset is arranged by ascending zip code and price. There are 10450 observations of 18 variables. There are 149 unique zip codes included in the dataset.There are 43 unique neighborhoods. There are 171 zip codes that appear in the ZIP code dataset but not in the zillow rental price dataset. 

...
average_price_df|>
  ...
  knitr::kable()
```
Among all boroughs, the average rental price increases each year, with the exception of an decrease in average price in 2020 in Brooklyn, Manhattan and Queens and in 2021 in Brooklyn and Queens. These differences may be attributed to changes in rent the covid-19 pandemic.
